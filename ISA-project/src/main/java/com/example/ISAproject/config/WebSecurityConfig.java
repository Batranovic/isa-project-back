...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
			...
			//.antMatchers("/api/companies/*").hasAuthority("ROLE_USER")
			...
			.antMatchers("/api/reservations/cancel/*/*").hasAuthority("ROLE_USER")
			.antMatchers("api/reservations/userReservation/*").permitAll()
			.antMatchers("/api/appointments/reserved/*").permitAll()
			.antMatchers("/api/reservations/withQr/*").permitAll()

...
insert into users(name, surname, email, password, city, country, phone_number, profession, company_information, is_active) values ('ime2', 'prz2', 'email2', 'pass2', 'city2', 'country2', 'phone2', 'profession2', 'info2', false);
insert into users(name, surname, email, password, city, country, phone_number, profession, company_information, is_active) values ('ime3', 'prz3', 'email3', 'pass3', 'city3', 'country3', 'phone3', 'profession3', 'info3', false);

...
insert into equipments(name, equipment_type, description, quantity, reserved_quantity, version, price) values ('X-Ray Machine', 'Medical Imaging', 'Advanced X-ray equipment', 30, 0, 0, 100);
insert into equipments(name, equipment_type, description, quantity,reserved_quantity, version, price) values ('Hospital Bed', 'Furniture', 'Specialized bed for patients', 40, 0, 0, 200);
...
insert into equipments(name, equipment_type, description, quantity,reserved_quantity, version, price) values ('MRI Scanner', 'Medical Imaging', 'Magnetic Resonance Imaging machine', 30, 0, 0,100);
